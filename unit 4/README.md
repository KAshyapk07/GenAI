...
- **[Assignment: Evaluated Agentic RAG System](./Assignment.ipynb)**: Build a multi-agent system that retrieves information, generates answers, evaluates them with DeepEval, and retries if quality is below threshold.
...
| `langchain-huggingface` | Assignment | HuggingFaceEmbeddings (FAISS vector store) |
